...
const FireServices = () => {
    ...
    const features = [
        {
            ...
            description: "Advanced smoke and heat detection for early warnings.",
        },
        {
            id: 2,
            title: "Fire Suppression Solutions ",
            description: " Sprinklers, extinguishers, and gas suppression systems.",

        },
        {
            id: 3,
            title: "Emergency Evacuation Planning",
            description: "Safe exit strategies and fire drills.",
        },
        {
            id: 4,
            title: "Code & Compliance Assurance",
            description: "Meeting national and international fire safety standards.",
        },
        {
            id: 5,
            title: "24/7 Monitoring & Maintenance",
            description: " Ensuring fire systems are always operational.",
        },
    ];
    ...
    //                     <span className="mx-2">/</span>
    //                     <span className="text-[#8CB5FF] font-bold text-xl">Fire Services</span>
    //                 </div>
    //             </div>
    //         </div>
                            ...
                            <div className="space-y-4">
                                {features.map((feature, index) => (
                                    <div key={index} className="flex items-start p-3 rounded-lg hover:bg-blue-50 transition-all duration-300 group">
                                        ...
                                        <div className="ml-3">
                                            <span className="font-semibold text-gray-900 group-hover:text-gray-900 transition-colors duration-300">
                                                {feature.title}
                                            </span>
                                            <span className="ml-2 text-gray-700 group-hover:text-gray-900 transition-colors duration-300">
                                                - {feature.description}
                                            </span>
                                        </div>
                                    </div>
