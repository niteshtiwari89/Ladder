    ...
    <>
        ...
        <div className="relative w-full h-80 md:h-96 overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/peb-main-hero.png')",
                    backgroundPosition: 'center',
                }}
            >
                {/* Dark overlay to make text more readable */}
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
                ...
                <div className="flex items-center text-lg">
                    ...
                    <span className="mx-2">/</span>
                    <span className="text-[#8CB5FF] font-bold text-xl hover:scale-105 transition-transform duration-300">PEB Design Vetting</span>
                </div>
        ...
        <div className="min-h-screen w-full bg-gray-50 relative overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 py-12">
                <div className="flex flex-col md:flex-row justify-evenly gap-8">
                    ...
                    {/* Right Side - Content */}
                    <div className="w-full md:w-2/3">
                        <h2 className="text-3xl text-center font-bold mb-6 text-gray-900 hover:text-blue-800 transition-colors duration-300">PEB Design Vetting</h2>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div className="w-full md:w-3/5 pr-0 md:pr-8">
                        <h2 className="text-2xl font-bold mb-8 flex items-center group">
                            <span className="group-hover:text-blue-800 transition-colors duration-300">Features of Our PEB Design Vetting</span>
                            <span className="ml-2 group-hover:scale-110 transition-transform duration-300">🚧 🏗️</span>
                        </h2>

                        <div className="space-y-5">
                            {features.map((feature) => (
                                <div key={feature.id} className="flex items-start group hover:-translate-x-1 transition-transform duration-300">
                                    <div className="flex-shrink-0 mt-1">
