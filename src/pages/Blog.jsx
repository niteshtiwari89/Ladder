        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          ...
          <div className="lg:col-span-1">
            {featuredPosts.map((post) => (
              <div 
                key={post.id} 
                className="mb-8 transition-all duration-300 hover:shadow-lg rounded-lg p-4 hover:bg-white"
              >
                <div className="mb-1 inline-block bg-gray-200 px-2 py-1 text-xs hover:bg-gray-300 transition-colors duration-300">
                  {post.category}
                </div>
                <h2 className="mb-4 text-xl font-bold hover:text-[#024965] transition-colors duration-300">
                  {post.title}
                </h2>
                {post.image && (
                  <img
                    src={post.image}
                    alt={post.title}
                    className="mb-4 h-auto w-full rounded transform hover:scale-[1.02] transition-transform duration-500"
                  />
                )}
                <div className="mb-4 flex items-center">
                  <div className="mr-2 h-8 w-8 overflow-hidden rounded-full bg-gray-300 hover:ring-2 ring-[#024965] transition-all duration-300">
                    <img
                      src="/profile-pic.png"
                      alt="author"
                      className="h-full w-full object-cover"
                  ...
                  <span className="text-sm text-gray-600 hover:text-gray-800 transition-colors duration-300">
                    {post.author}
                  </span>
                  <span className="mx-2 text-sm text-gray-400">•</span>
                  <span className="text-sm text-gray-600 hover:text-gray-800 transition-colors duration-300">
          ...
          <div className="lg:col-span-1">
            {regularPosts.map((post) => (
              <div 
                ...
                className="mb-8 transition-all duration-300 hover:shadow-lg rounded-lg p-4 hover:bg-white"
              >
                <div className="mb-1 inline-block bg-[#024965] px-2 py-1 text-xs text-white hover:bg-[#01354a] transition-colors duration-300">
                  {post.category}
                </div>
                <h2 className="mb-4 text-xl font-bold hover:text-[#024965] transition-colors duration-300">
                  {post.title}
                ...
                {popularPosts.map((_, index) => (
                  <button
                    ...
                    className={`mx-1 h-2 w-2 rounded-full transition-all duration-300 ${
                      index === activeIndex ? "bg-[#024965]" : "bg-gray-300 hover:bg-gray-400"
                    }`}
                    aria-label={`Go to slide ${index + 1}`}
                  />
                ))}
