    ...
    <>
        ...
        <div className="relative w-full h-80 md:h-96 overflow-hidden">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/mep-hero.png')",
                    backgroundPosition: 'center',
                }}
            >
                {/* Dark overlay to make text more readable */}
            ...
            <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
                ...
                <div className="flex items-center text-lg">
                    ...
                    <span className="mx-2">/</span>
                    <span className="text-[#8CB5FF] font-bold text-xl hover:scale-105 transition-transform duration-300">MEP Designing</span>
                </div>
        ...
        <div className="min-h-screen w-full bg-gray-50 relative overflow-hidden">
            ...
            <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-4xl shadow-md p-6 md:w-1/3 hover:shadow-xl transition-shadow duration-300 hover:-translate-y-1 transition-transform">
                        <h2 className="text-xl font-bold mb-6">EPC - Turnkey Solutions</h2>
                                ...
                                <div key={service.id} className="border-b pb-4 group">
                                    <div className="flex items-center">
                                        <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mr-3 group-hover:bg-blue-200 transition-colors duration-300">
                                            <span className="text-blue-600 text-sm group-hover:scale-110 transition-transform">✓</span>
                                        </div>
                    ...
                    <div className="md:w-2/3 overflow-hidden rounded-4xl shadow-md hover:shadow-xl transition-shadow duration-300">
                        <img
                            src="/mep-img.png"
                            alt="Construction site with workers in yellow safety vests and helmets reviewing plans at a building site"
            ...
            <div className="relative z-10 container mx-auto px-4 py-12">
                <div className="flex flex-col md:flex-row gap-8">
                        ...
                        <div className="p-6 relative">
                            ...
                            <div className="mt-8 flex justify-center">
                                <img
                                    src="/mep-img1.png"
                                    alt="3D model of building structure"
                                    className="w-48 h-auto -mb-7 object-contain opacity-80 grayscale hover:opacity-90 hover:grayscale-0 transition-all duration-500"
                                />
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Right Side - Content */}
                    <div className="w-full md:w-2/3">
                        <h2 className="text-3xl text-center font-bold mb-6 text-gray-900 hover:text-blue-800 transition-colors duration-300">Erection Services</h2>

                        <div className="space-y-6 text-gray-700">
                            <p className="leading-relaxed text-lg hover:text-gray-800 transition-colors duration-300">
                                At Blueladder Engineering Company, we specialize in providing top-quality civil erection
                                services for a wide range of projects. From small residential developments to large-scale
                                commercial and industrial projects, we have the expertise and resources to handle all of
                                your civil erection needs. Our team of highly skilled professionals has extensive
            ...
            <div className="w-full bg-gray-50 py-8 md:py-12">
                <div className="max-w-7xl mx-auto px-4 sm:px-6">
                    <div className="text-gray-800 text-xl md:text-base leading-relaxed">
                        <p className='leading-relaxed text-lg hover:text-gray-900 transition-colors duration-300'>
                            We also conduct simulations to ensure that the systems will function properly once they are installed. Throughout the design process, we
                            work closely with our clients to ensure that their needs and expectations are met. We value open communication and transparency, and we
                            make sure to keep our clients informed at every stage of the project. In addition to MEP design, we also offer a range of other engineering
                            services, including project management, construction management, and commissioning. Our team has a track record of delivering high-quality
        ...
        <div className="w-full flex justify-center items-center p-6 min-h-[400px] md:min-h-[400px]">
            <div className="flex flex-col md:flex-row max-w-7xl w-full gap-6 md:gap-8 items-center justify-center">
                {/* First card - Mechanical with hover effect */}
                <div className="w-full md:w-1/3 h-48 md:h-56 rounded-4xl overflow-hidden relative group hover:shadow-xl transition-all duration-300">
                    <div
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <h3 className="text-white text-2xl font-semibold group-hover:scale-110 transition-transform duration-300">{domain[0].title}</h3>
                    </div>
                </div>

                {/* Middle card - Electrical (larger) with pulse animation */}
                <div className="w-full md:w-1/3 h-60 md:h-64 rounded-4xl overflow-hidden relative group hover:shadow-xl transition-all duration-300 animate-pulse-slow">
                    <div
                        className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-110"
                        style={{ backgroundImage: `url(${domain[1].imageUrl})` }}
                    />
                    <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-30 transition-opacity duration-300"></div>
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-center">
                        <h3 className="text-white text-2xl font-semibold mb-2 group-hover:scale-105 transition-transform duration-300">{domain[1].title}</h3>
                        <p className="text-white text-sm group-hover:text-blue-200 transition-colors duration-300">{domain[1].description}</p>
                    </div>
                </div>

                {/* Third card - Plumbing with hover effect */}
                <div className="w-full md:w-1/3 h-48 md:h-56 rounded-4xl overflow-hidden relative group hover:shadow-xl transition-all duration-300">
                    <div
                        className="absolute inset-0 bg-cover bg-center transition-transform duration-500 group-hover:scale-110"
                        style={{ backgroundImage: `url(${domain[2].imageUrl})` }}
                    ...
                    <div className="absolute inset-0 bg-black opacity-40 group-hover:opacity-30 transition-opacity duration-300"></div>
                    <div className="absolute inset-0 flex items-center justify-center">
                        <h3 className="text-white text-2xl font-semibold group-hover:scale-110 transition-transform duration-300">{domain[2].title}</h3>
                    </div>
                </div>
            </div>
        </div>
