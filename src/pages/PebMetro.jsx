    ...
    <>
        ...
        <div className="relative w-full h-80 md:h-96 group">
            ...
            <div
                ...
                style={{
                    backgroundImage: "url('/peb-metro-hero.png')",
                    backgroundPosition: 'center',
                }}
            >
                {/* Dark overlay to make text more readable */}
                <div className="absolute inset-0 bg-black opacity-60 group-hover:opacity-50 transition-opacity duration-300"></div>
            </div>

            {/* Content container */}
            <div className="relative h-full flex flex-col items-center justify-center text-white px-4">
                {/* Main heading with animation */}
                <h1 className="text-4xl md:text-5xl font-bold mb-4 text-center transform transition-transform duration-500 hover:scale-105">
                    PEB Metro Stations
                </h1>
                ...
                <div className="flex items-center text-lg flex-wrap justify-center">
                    ...
                    <span className="mx-2">/</span>
                    <span className="hover:underline transition-all duration-300 hover:text-blue-200">Pre Engineered Steel Structures</span>
                    <span className="mx-2">/</span>
                    <span className="text-[#8CB5FF] font-bold text-xl transform hover:scale-110 transition-transform duration-300">PEB Metro Stations</span>
                </div>
        ...
        <div className="min-h-screen w-full bg-gray-50 relative overflow-hidden">
            <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-4xl shadow-md p-6 md:w-1/3 hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1">
                        ...
                        <div className="space-y-6">
                            {services.map((service) => (
                                <div key={service.id} className="border-b pb-4 hover:border-blue-300 transition-colors duration-300">
                                    <div className="flex items-center group">
                                        <div className="w-6 h-6 rounded-full bg-blue-100 flex items-center justify-center mr-3 group-hover:bg-blue-200 transition-colors duration-300">
                                            <span className="text-blue-600 text-sm group-hover:scale-125 transition-transform duration-200">✓</span>
                                        </div>
                    ...
                    <div className="md:w-2/3 group">
                        <div className="relative overflow-hidden rounded-4xl">
                            <img
                                src="/peb-metro-img1.png"
                                alt="Construction site with workers in yellow safety vests and helmets reviewing plans at a building site"
                                className="w-full h-[460px] object-contain transition-transform duration-700 group-hover:scale-105"
                            />
                        </div>

                        <h1 className='text-xl text-center font-bold mt-4 transform hover:scale-105 transition-transform duration-300 inline-block'>
                            PEB Metro Stations
                        </h1>

                        <p className='leading-base mt-6 transition-all duration-500 hover:text-gray-800'>
                            PEB Metro stations refer to the stations on a metro (or subway) system in a city that uses pre-engineered buildings (PEB) as the structural element for the construction of the stations. Pre-engineered buildings are prefabricated structures that are manufactured off-site and then assembled on-site. They are a cost-effective and efficient solution for the construction of buildings and are often used for industrial, commercial, and infrastructure projects. The use of PEB structures for metro stations allows for the rapid construction of these stations, as the prefabricated components can be easily assembled on-site.
                        </p>
                    </div>
                </div>
            ...
            <div className="p-10 md:p-10 lg:p-10 rounded-lg mx-auto">
                <h2 className="text-gray-800 text-xl md:text-2xl font-bold mb-6 transform hover:scale-[1.01] transition-transform duration-300 inline-block">
                    Why Choose Blueladder EPC Solutions for PEB Metro Stations?
                </h2>
                ...
                {/* <div className="space-y-6">
                    {benefits.map((benefit, index) => (
                        <div 
                            key={index} 
                            className="flex items-start p-4 rounded-lg hover:bg-blue-50 transition-all duration-300 hover:shadow-sm"
                        >
                            <div className="text-blue-600 mr-2 mt-1 flex-shrink-0 transform hover:rotate-12 transition-transform duration-300">
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                                    <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                                </svg>
                            </div>
                            <p className="text-gray-800 text-sm md:text-base">
                                <span className="font-medium hover:text-blue-600 transition-colors duration-300">{benefit.title}:</span> {benefit.description}
                            </p>
                        </div>
                    ))}
                </div> */}
            ...
            <div className="p-12 text-center text-[#024965] text-lg md:text-lg">
                <p className="transform hover:scale-[1.01] transition-transform duration-300 inline-block">
                    Are you ready to elevate your metro station project with our top-notch PEB solutions? Blueladder EPC Solutions is your trusted partner for sustainable and innovative construction. Contact us today to discuss your metro station project and discover how we can bring your vision to life.
                </p>
            </div>

            <div className="w-full mx-auto md:-mb-2 group">
